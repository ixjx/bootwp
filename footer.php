...
<hr>
      ...
      <footer>
        <p>Copyright &#169;&nbsp;<? the_time('Y');?>&nbsp;<a href="http://ixjx.github.com"><? bloginfo('name');?></a></p>
         <p>部分代码和设计风格参考<a href="http://blog.dandyweng.com" target="_blank">Dandy's Blog</a></p>
        <p>珍爱生命，远离IE。请使用Chrome或Safari，你懂的 :)</p>
      </footer>
    </div> <!-- /container -->
